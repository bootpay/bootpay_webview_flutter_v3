...
class SampleMenu extends StatelessWidget {
  ...
  Future<void> _onAddToCache(
    ...
    ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Added a test entry to cache.')));
            ...
            IconButton(
              ...
              onPressed: !webViewReady
                ...
                if (await controller!.canGoBack()) {
                  ...
                  // ignore: deprecated_member_use
                  ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('No back history item')));
            ...
            IconButton(
              ...
              onPressed: !webViewReady
                ...
                if (await controller!.canGoForward()) {
                  ...
                  // ignore: deprecated_member_use
                  ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('No forward history item')));
